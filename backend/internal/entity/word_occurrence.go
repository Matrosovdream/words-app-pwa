...
type WordOccurrence struct {
	...
	WordID         string    `gorm:"column:word_id;type:uuid;index:idx_word_page,priority:1,unique"`
	ParsedPageID   string    `gorm:"column:parsed_page_id;type:uuid;index:idx_word_page,priority:2"`
